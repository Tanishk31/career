...
//           style={{
//             backgroundImage: `url('offshore.jpg')`,
//           }}
//         />
...
//               </button>
//               <Link to="/services">
//                 <button className="bg-transparent text-[15px] font-bold text-white px-8 py-3 rounded-full text-lg border border-white hover:bg-white/20 transition-colors duration-300">
//                   Explore Services
//                 </button>
//               </Link>
//             </div>
...
const HomePage = () => {
  ...
  const [activeIndex, setActiveIndex] = useState(null);
  const aboutSectionRef = useRef(null);
  const productsSectionRef = useRef(null); // Add a ref for the products section
  ...
  return (
    <div className="font-montserrat">
      ...
      <div className="relative w-full h-screen flex justify-center items-center overflow-hidden ">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-20">
          <div
            className={`text-center text-white transition-all duration-1500 ease-in-out ${isHeroVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-8"
              }`}
          >
            ...
            <div className="flex flex-col items-center">
              <svg
                className={`w-[500px] h-5 transition-all duration-500 ease-in-out ${linesVisible ? "stroke-animate" : ""
                  }`}
                viewBox="0 0 500 20"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              ...
              <svg
                className={`w-[500px] h-5 transition-all duration-500 ease-in-out mr-10 -mt-3 ${linesVisible ? "stroke-animate" : ""
                  }`}
                viewBox="0 0 400 20"
                fill="ffffff"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="space-x-4">
              <button
                onClick={scrollToProducts} // Update onClick to scroll to products
                className="bg-sky-400 text-[15px] font-bold text-white px-8 py-3 rounded-full text-lg hover:bg-navy-900 transition-colors duration-300"
              >
                Explore Products
              </button>
              <Link to="/services">
      ...
      >
        <div
          className={`flex justify-between items-start w-[80%] mt-10 p-10 bg-blue-50 rounded-3xl shadow-lg ${isAboutVisible
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-12"
            } transition-all duration-1000 ease-in-out`}
        >
      ...
      <div ref={productsSectionRef} className="flex w-[75%] mx-auto flex-col gap-20">
        <h1 className="text-[40px] font-bold font-yaro text-[#1D3D71]">
          | Our Products
        </h1>
        <EnhancedCarousel />
        <Link className="mx-auto mb-10" to="/services">
      ...
      <div className="bg-white py-16">
        <div className="p-20 mx-auto text-center">
          <h2 className="text-5xl text-left font-bold mb-10 text-[#1D3D71] font-yaro">             Common Queries
          </h2>
          <p className="text-xl text-left mb-8 text-[#1D3D71]">
            Your Answers to Common Questions
          </p>
